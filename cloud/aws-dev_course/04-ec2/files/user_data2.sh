...
sudo yum update -y > /home/ec2-user/log.txt
sudo yum groupinstall -y "Development Tools" >> /home/ec2-user/log.txt

# Install new Python
sudo amazon-linux-extras enable python3.8 >> /home/ec2-user/log.txt
sudo yum install -y python3.8 >> /home/ec2-user/log.txt
sudo update-alternatives --install /usr/local/bin/python3 python3 /usr/bin/python3.8 0 >> /home/ec2-user/log.txt
sudo update-alternatives --install /usr/local/bin/pip3 pip3 /usr/bin/pip3.8 0 >> /home/ec2-user/log.txt
